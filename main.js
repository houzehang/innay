...
app.on('ready', ()=>{
    ...
    let $main = new BrowserWindow({width: 1440, height: 900, 
        resizable: true,
        center: true,
        frame: true,
    ...
    $main.webContents.setUserAgent('Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.1 Safari/537.36');
    // 加载本地入口文件，用于生成主UI界面
