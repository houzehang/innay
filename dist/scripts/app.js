...
},{"../const.js":1,"./context":7,"./eventer":8}],4:[function(require,module,exports){
/**
 * 本地存储类
 * 用于将信息固化到本地存储
...
},{"../const.js":1,"./DataManager":3,"./calendar":6,"./context":7,"./network":12,"./room":13}],6:[function(require,module,exports){
class Calendar {
  constructor(inst) {
    this.$inst = inst
    this.$now  = new Date()
...
},{"./Storage":4}],8:[function(require,module,exports){
...
},{"../const.js":1,"./DataManager":3,"./Viewer":5,"./context":7,"./jquery.tmpl.js":10,"./loading":11,"./network":12,"q":15}],10:[function(require,module,exports){
...
},{"./context":7,"./eventer":8,"q":15}],13:[function(require,module,exports){
...
class Room {
	...
	__start_stream() {
        ...
        let media = AgoraRTC.createStream({
		...
		media.setVideoProfile(Const.VIDEO_QUALITY);

        media.on("accessAllowed", function() {
        });
        media.on("accessDenied", function() {
			alert("无法访问您的摄像头或麦克风")
        });

        media.init(()=>{
			media.play('master-video');

			this.$client.publish(media, function (err) {
...
},{"../const":1,"./AgoraRTCSDK-2.2.0":2,"./context":7,"q":15}],14:[function(require,module,exports){
